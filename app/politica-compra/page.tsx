          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                ...
                tratados individuais na plataforma Or Halachá. Ao realizar uma compra, você concorda
                com todos os termos aqui descritos.
              </p>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg bg-yellow-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-yellow-700">
                  ...
                  <li>• Assinatura anual: R$ 299,90/ano (2 meses grátis)</li>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Assinaturas são renovadas automaticamente. Você pode cancelar a qualquer momento
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Cancelamentos podem ser feitos a qualquer momento. O acesso permanece ativo até
