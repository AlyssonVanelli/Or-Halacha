...
export async function GET() {
  try {
    console.log('=== VERIFICANDO WEBHOOK EM PRODUÇÃO ===')
    ...
    const productionWebhook = webhooks.data.find(webhook => webhook.url === productionUrl)
    ...
    if (productionWebhook) {
      ...
      const hasCheckoutEvent = productionWebhook.enabled_events.includes(
