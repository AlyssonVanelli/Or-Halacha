      ...
      try {
        ...
        if (response.ok) {
          ...
          const accessData = {
            ...
            hasPlusFeatures: data.access.hasActiveSubscription && data.supabase.subscription?.explicacao_pratica,
            hasAnyAccess: data.access.hasAnyAccess,
            purchasedBooks: data.supabase.purchasedBooks?.map((pb: any) => pb.division_id) || []
          }
      ...
      if (!response.ok) {
        ...
        if (responseData.url) {
          ...
          if (responseData.treatiseId) {
            console.log('📚 Tratado será processado como assinatura no Stripe:', responseData.treatiseId)
          }
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                    ...
                    <div className="rounded-xl border-2 border-gray-200 bg-white p-6 shadow-lg">
                      <div className="text-center">
                        ...
                        >
                          {loadingPurchase === 'tratado-avulso' ? 'Processando...' : 'Assinar Tratado'}
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="rounded-xl border-2 border-purple-500 bg-gradient-to-br from-purple-50 to-indigo-50 p-6 shadow-lg">
                      <div className="text-center">
                        ...
                        <p className="mb-4 text-sm text-gray-600">Acesso completo + explicações práticas</p>
                        <div className="mb-4">
                    ...
                    <div className="rounded-xl border-2 border-gray-200 bg-white p-6 shadow-lg">
                      <div className="text-center">
                        ...
                        <p className="mb-4 text-sm text-gray-600">Acesso completo + explicações com desconto</p>
                        <div className="mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        {/* Botão de ação */}
                        <div className="w-full rounded-lg bg-gradient-to-r from-yellow-500 to-orange-500 px-4 py-3 text-center font-semibold text-white shadow-md transition-all duration-200 group-hover:shadow-lg group-hover:scale-105">
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        {/* Botão de ação */}
                        <div className="w-full rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-3 text-center font-semibold text-white shadow-md transition-all duration-200 group-hover:shadow-lg group-hover:scale-105">
