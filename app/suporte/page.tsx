          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-xl bg-white p-8 shadow-lg">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Descreva sua dúvida ou problema em detalhes para que possamos ajudá-lo da melhor forma possível.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500 focus:outline-none"
                ...
                {status === 'sent' && (
                  <div className="rounded-lg bg-green-50 border border-green-200 p-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h3 className="font-semibold text-green-800">{SUPPORT_MESSAGES.SUCCESS.TITLE}</h3>
                ...
                <Button 
                  type="submit" 
                  disabled={loading || status === 'sent'} 
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 py-3 text-lg font-semibold shadow-lg transition-all duration-200 hover:shadow-xl"
                >
                  {loading ? (
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-xl bg-white p-6 shadow-lg">
                ...
                <p className="text-sm text-gray-500 mt-1">16h às 22h (horário de Israel)</p>
              </div>
            </div>
          </div>
        </div>
