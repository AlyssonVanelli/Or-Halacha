  ...
  switch (event.type) {
    ...
    case 'customer.subscription.deleted': {
      ...
      if (
        ...
        const periodStartTs = (item as Stripe.SubscriptionItem & { current_period_start?: number })[
          'current_period_start'
        ]
        const periodEndTs = (item as Stripe.SubscriptionItem & { current_period_end?: number })[
          'current_period_end'
        ]
