    ...
    <>
      ...
      <div className="flex min-h-screen flex-col">
        <main className="flex-1">
          <div className="w-full bg-slate-50 py-12 dark:bg-slate-900 md:py-24 lg:py-32">
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-12 text-center">
                  ...
                  <p className="mx-auto max-w-2xl text-lg text-slate-600">
                    Respostas baseadas nas fontes tradicionais para as dúvidas mais comuns sobre
                    Halachá e Judaísmo
                  </p>
                </div>
                      ...
                      {openIndex === i && (
                        <div className="space-y-4 px-6 pb-6">
                          ...
                          {item.references && item.references.length > 0 && (
                            <div className="rounded-r-lg border-l-4 border-slate-200 bg-slate-50 p-4">
                              <h4 className="mb-2 font-semibold text-slate-900">Referências:</h4>
